...
type createConfig struct {
	KeysFile          string `long:"keys-file" short:"f" description:"Keys file location (default: ~/.gorwallet/keys.json (*nix), %USERPROFILE%\\AppData\\Local\\Gorwallet\\key.json (Windows))"`
