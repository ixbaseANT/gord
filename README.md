...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ixbasANT/gord)
...
```bash
$ git clone https://github.com/ixbasANT/gord
$ cd kaspad
$ go install . ./cmd/...
```
...
The [integrated github issue tracker](https://github.com/ixbasANT/gord/issues)
