...
import (
	...
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/blockwindowheapslicestore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/daawindowstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/ixbaseANT/gord/domain/consensus/model"
	"github.com/ixbaseANT/gord/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/ixbaseANT/gord/domain/consensus/processes/parentsmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/pruningproofmanager"
	...
	consensusdatabase "github.com/ixbaseANT/gord/domain/consensus/database"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/acceptancedatastore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/blockheaderstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/blockrelationstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/blockstatusstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/blockstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/consensusstatestore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/daablocksstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/finalitystore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/multisetstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/pruningstore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/ixbaseANT/gord/domain/consensus/datastructures/utxodiffstore"
	"github.com/ixbaseANT/gord/domain/consensus/model/externalapi"
	"github.com/ixbaseANT/gord/domain/consensus/model/testapi"
	"github.com/ixbaseANT/gord/domain/consensus/processes/blockbuilder"
	"github.com/ixbaseANT/gord/domain/consensus/processes/blockprocessor"
	"github.com/ixbaseANT/gord/domain/consensus/processes/blockvalidator"
	"github.com/ixbaseANT/gord/domain/consensus/processes/coinbasemanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/consensusstatemanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/dagtopologymanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/dagtraversalmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/difficultymanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/finalitymanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/ghostdagmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/headersselectedtipmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/mergedepthmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/pastmediantimemanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/pruningmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/reachabilitymanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/syncmanager"
	"github.com/ixbaseANT/gord/domain/consensus/processes/transactionvalidator"
